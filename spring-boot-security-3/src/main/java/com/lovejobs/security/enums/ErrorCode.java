package com.lovejobs.security.enums;
...
public enum ErrorCode {
    ...
    E_WRONG_USERNAME_PASSWORD(402, "wrong username or password"),
    E_ACCOUNT_DISABLE(403, "account disable"),
    E_ACCOUNT_NOT_FOUND(404, "account not found"),
    E_TOKEN_NOT_FOUND(405, "token not found"),
    E_TOKEN_EXCEPTION(406, "token exception"),
